...
net = cv2.dnn.readNet("/home/smartbridge/project_ws/src/mybot_motion/scripts/yolov3.weights", "/home/smartbridge/ros_work/src/mybot_motion/scripts/yolov3.cfg") 
classes = []
#specify the location of the files in the code
with open("/home/smartbridge/project_ws/src/mybot_motion/scripts/yolov3.txt", "r") as f:
